# lang-eng — Claude Instructions

## Module Purpose

Ships English `eng.traineddata` as its own artifact, so the model never lands
...
unzip -l sdk/lang-eng/build/outputs/aar/uncial-lang-eng.aar | grep tessdata
```
